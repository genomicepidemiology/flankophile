...
Install Miniconda3 (version 4.11.0 or 22.11.1) and [Snakemake](https://snakemake.readthedocs.io/en/stable/index.html) (version 6.9.1) to run Flankophile. 
...
R base - 4.1.3, Tidyverse - 1.3.2, ggtree - 3.2.0, gggenes - 0.4.1, treeio - 1.18.0, ape - 5.6, ggnewscale - 0.4.7
